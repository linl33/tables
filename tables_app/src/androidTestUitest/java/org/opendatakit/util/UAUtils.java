...
public class UAUtils {
  public static boolean turnOnCustomHome(UiDevice mDevice) {
    ...
    try {
      ...
      mDevice.takeScreenshot(new File("/sdcard/tables-screenshot-1-" + System.currentTimeMillis() + ".png"));
      ...
      if (preference == null) {
        mDevice.takeScreenshot(new File("/sdcard/tables-screenshot-2-" + System.currentTimeMillis() + ".png"));
      }
